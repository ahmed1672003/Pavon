...
public interface ICommandsRepository<TEntity> where TEntity : class, new()
{
    ...
    Task<int> ExecuteUpdateAsync(Expression<Func<TEntity, bool>> predicate = null, CancellationToken cancellation = default);
